...
defmodule Jacobin.MixProject do
  use Mix.Project
  ...
  def project do
    ...
    [
      ...
      aliases: aliases(),
      description: "A flavour of Bonfire for Jacobin",
        homepage_url: "https://bonfirenetworks.org/",
        source_url: "https://github.com/bonfire-networks/jacobin",
        package: [
          licenses: ["AGPL-3.0"],
          links: %{
            "Repository" => "https://github.com/bonfire-networks/jacobin"
          }
        ],
        docs: [
          main: "readme",
